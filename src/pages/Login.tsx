...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 py-8 font-nunito relative overflow-hidden">
      {/* Decorative citrus wheel — bottom-left corner */}
      <img src={citrusWheel} alt="" aria-hidden="true" className="pointer-events-none select-none absolute -bottom-20 -left-20 w-80 opacity-100 -rotate-[15deg]" style={{ filter: 'brightness(1.1) saturate(1.3) hue-rotate(-10deg)' }} />
