...
const HowItWorksSection = ({ onOpenDemo }: HowItWorksSectionProps) => {
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0" style={{ backgroundColor: "rgba(6,34,71,0.75)" }} />

      <div className="relative z-10 mx-auto max-w-5xl text-center">
        <p className="mb-3 text-sm font-[800] uppercase tracking-[0.2em]" style={{ color: "#EB5E07" }}>
          How It Works
        </p>
        <h2 className="mb-5 text-3xl font-[900] text-white md:text-5xl leading-tight">
        ...
        <div className="mb-4 inline-flex flex-col items-center gap-3 sm:flex-row">
          <button
            onClick={onOpenDemo}
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {STEPS.map((s) => (
            <div
              key={s.step}
              className="rounded-xl border-t-4 px-6 py-8 text-left"
              style={{ backgroundColor: "#FFFFFF", borderColor: "#5F8B40" }}
            >
